...
PARAMETER_HEIZBETRIEB_HEIZUNGSPUFFER_LADESCHWELLWERT = "MinimalladungHeizbetriebWaehrendLadevorgang"
...
ERSATZPARAMETER_HEIZBETRIEB_HEIZUNGSPUFFER_LADESCHWELLWERT = 0.2 # Erst ab dieser Ladung wird die Heizung wieder aktiviert
